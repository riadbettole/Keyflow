				...
				<div className="p-3 border-t border-gray-700">
					...
					<div className="flex items-center gap-2.5 px-3 py-2 mb-2">
						<div className="w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-500/30 flex items-center justify-center shrink-0">
							<span className="text-xs font-semibold text-indigo-400 leading-none">
								{userInitials}
							</span>
						</div>
						<div className="flex-1 min-w-0">
							<p className="text-xs font-medium text-gray-300 truncate leading-none mb-0.5">
								{userName}
							</p>
							<p className="text-xs text-gray-600 truncate leading-none">{session?.user?.email}</p>
						</div>
					</div>
					...
					<button
						...
						className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-sm text-gray-500 hover:text-gray-300 hover:bg-gray-800 transition-colors"
					>
						<svg
							width="14"
							height="14"
